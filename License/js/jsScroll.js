...
function jsScroll(obj, w, className, r)
{
...
function scrollResetSize(o) {
	...
	o.scrollBar.style.width = (o.scrollBarWidth - o.scrollBarRight) + 'px';
	o.scrollBar.style.height = o.clientHeight + 'px'; // ct
	o.scrollBar.style.top = y + borderTop + 'px';  // ct
	o.scrollBar.style.left = x + o.offsetWidth - o.scrollBarWidth + 'px';
	o.scrollBarIndex.style.width = (o.scrollBarWidth - o.scrollBarRight) + 'px';
	...
	o.scrollBarIndex.style.right = o.scrollBarRight + "px";
