...
Section /o "Search with filters" SearchWithFilters
	...
	# exclude "C:\WINDOWS\System", "C:\WINDOWS\System32", "C:\WINDOWS\Help" paths from search in
	# exclude "config" directory from search in (C:\WINDOWS\system32\config, C:\WINDOWS\Config, D:\WINDOWS\pchealth\helpctr\Config, ...)
