...
| And by Tallmaris (Leandro Tramma): Unicode compatibility       |
o----------------------------------------------------------------o
*/
...
//          FILE * hFile;
//					#ifdef _UNICODE
//						if ( _wfopen_s(&hFile, pField->pszState, _T("rb")) != 0)
//					#else
...
//          }
//          rewind(hFile);
//          TCHAR *pszData = (TCHAR*)MALLOC(nDataLen+1);
//
      ...
      if(pField->nType == FIELD_LISTBOX || pField->nType == FIELD_COMBOBOX) {
        ...
        switch (lpdis->itemAction)
        {
          ...
          case ODA_DRAWENTIRE:
          {
            ...
            LPTSTR pszItemText = (TCHAR*)MALLOC(g_nBufferSize);
...
//================================================================
  ...
  TCHAR *pszBuffer = (TCHAR*)MALLOC(nBufLen);
  ...
  //--------------------------------------------------------------
    ...
    //--------
      case FIELD_LISTBOX:
      {
        ...
        if (nLength > nBufLen) {
          FREE(pszBuffer);
          nBufLen = nLength;
          pszBuffer = (TCHAR*)MALLOC(nBufLen);
          if (!pszBuffer) return false;
        }
        TCHAR *pszItem = (TCHAR*)MALLOC(nBufLen);
    ...
    //---------------
      ...
      case FIELD_COMBOBOX:
      {
        ...
        TCHAR* pszBuf2 = (TCHAR*)MALLOC(nBufLen+2);
...
//            FILE * hFile;
//						#ifdef _UNICODE
//							if ( _wfopen_s(&hFile, pField->pszState, _T("wb")) != 0)
//						#else
      ...
      case FIELD_DATETIME:
        {
          ...
          TCHAR* pszDate = (TCHAR*)MALLOC(10+1);
          TCHAR* pszDayOfWeek = (TCHAR*)MALLOC(3+1);
          TCHAR* pszTime = (TCHAR*)MALLOC(8+1);
      ...
      case FIELD_BUTTON:
        {
		  ...
		  if(lstrcmp(pField->pszState,_T(""))!=0 && (pField->nFlags & FLAG_OPEN_FILEREQUEST || pField->nFlags & FLAG_SAVE_FILEREQUEST || pField->nFlags & FLAG_DIRREQUEST))
          {
			lstrcpyn(pszBuffer, (LPTSTR)pField->pszState, g_nBufferSize);
          }
          else
          if(lstrcmp(pField->pszState,_T(""))!=0 && pField->nFlags & FLAG_FONTREQUEST)
          {
            lstrcpyn(pszBuffer, (LPTSTR)pField->pszState, g_nBufferSize);
