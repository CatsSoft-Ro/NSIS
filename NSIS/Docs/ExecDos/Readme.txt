...
How To Use
  ...
  ExecDos::exec [/NOUNLOAD /ASYNC] [/TIMEOUT=xxx] [/TOSTACK | /DETAILED | /TOWINDOW | /TOFUNC] [/ENDFUNC=func] application_to_run [stdin_string] [log_file_name | window | function]
...
TOFUNCTION option and isdone entry point added by AfrowUK
