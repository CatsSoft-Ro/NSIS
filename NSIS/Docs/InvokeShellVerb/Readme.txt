...
~ InvokeShellVerb.dll  v1.0 (4.0 KB)
~ Written by Robert Strong

~ NSIS plugin to Invoke a shell object's verb

~   Last build: 9th February 2011, Microsoft Visual C++ 6
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 ...
 Pop $Var
  ...
  file_name - the file name of the file that will have DoIt called on its
              verb.
  reource_id - the resource id of the verb label's string used to identify the
               verb on the shell object.
